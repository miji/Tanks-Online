...
namespace UnityStandardAssets.Network
{
    ...
    {
		static Color[] Colors = new Color[] { Color.black, Color.blue, Color.red, Color.cyan, Color.magenta, Color.green, Color.gray, Color.yellow };
        ...
        void Update()
        {
            if (Application.loadedLevelName != LobbyManager.s_Singleton.lobbyScene)
                return;
            ...
            if (isLocalPlayer &&  (obj == null || !obj.isFocused) )
            {
                ...
                if (!readyToBegin && Input.GetButtonUp("Fire"+ localIdx))
                {
